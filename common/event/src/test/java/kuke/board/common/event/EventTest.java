...
class EventTest {
    ...
    void serde() {
        ...
        assertThat(payload).isInstanceOf(payload.getClass());
        ...
        assertThat(resultPayload.getBoardId()).isEqualTo(payload.getBoardId());
        assertThat(resultPayload.getWriterId()).isEqualTo(payload.getWriterId());
        assertThat(resultPayload.getCreatedAt()).isEqualTo(payload.getCreatedAt());
        assertThat(resultPayload.getModifiedAt()).isEqualTo(payload.getModifiedAt());
    }
}