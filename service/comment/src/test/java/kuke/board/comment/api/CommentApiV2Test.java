...
public class CommentApiV2Test {
    ...
    void read() {
        CommentResponse response = restClient.get()
                .uri("/v2/comments/{commentId}", 154691794323648512L)
                .retrieve()
    ...
    void readAll() {
        ...
        /**
         * comment.getCommentId() = 154863594543587331
         * comment.getCommentId() = 154863594577141763
         * comment.getCommentId() = 154863594581336065
         * comment.getCommentId() = 154863594581336079
         * comment.getCommentId() = 154863594581336090
         * comment.getCommentId() = 154863594581336094
         * comment.getCommentId() = 154863594581336103
         * comment.getCommentId() = 154863594581336116
         * comment.getCommentId() = 154863594581336122
         * comment.getCommentId() = 154863594581336130
         */
    }
